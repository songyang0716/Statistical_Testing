...
pre_control_var / length(pre_constrol) + post_control_var / length(post_control)
...
## Use GEE model to solve this problem
```{r, message=FALSE, warning=FALSE}

```

## Use mix effects model to solve this problem
```{r, message=FALSE, warning=FALSE}
